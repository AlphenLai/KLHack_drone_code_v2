...
namespace WSDKTest
{
    public sealed partial class MainPage : Page
    {
        ...
        static double WP_tolarence = 0.05f;
        ...
        static PID rollPID = new PID(0.01, 0, 0, max_speed);
        static PID pitchPID = new PID(1, 0, 0.1, max_speed);
        ...
        private void SetWP()
        {
            ...
            temp_wp = RotationMatrix(new Position(2, 0), CompassBoundary(-local_heading));
            myWP[3].x = temp_wp.x;
            myWP[3].y = temp_wp.y;
        ...
        {
            VideoProtectionTimerAsync = new System.Timers.Timer(20000);
